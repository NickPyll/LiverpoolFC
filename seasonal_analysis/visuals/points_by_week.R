points.by.week <-
  ...
  add_annotations(
    x = 0, y = 100, text = "Manchester City 2017/2018 = 100 points", xref = "x", yref = "y", showarrow = F, xanchor = "left",
    font = list(size = 16)
  ) %>%
  add_annotations(
    x = 0, y = 87, text = "Average points by champion = 87 points", xref = "x", yref = "y", showarrow = F, xanchor = "left",
    font = list(size = 16)
  ) %>%
  add_annotations(
    x = 0, y = 75, text = "Manchester United 1996/1997 = 75 points", xref = "x", yref = "y", showarrow = F, xanchor = "left",
    font = list(size = 16)
  ) %>%
  add_annotations(
    x = 0, y = 34, text = "West Bromwich 2005/2006 = 34 points", xref = "x", yref = "y", showarrow = F, xanchor = "left",
    font = list(size = 16)
  ) %>%
  add_annotations(
    x = 0, y = 42, text = "West Ham 2002/2003 = 42 points", xref = "x", yref = "y", showarrow = F, xanchor = "left",
    font = list(size = 16)
  ) %>%
