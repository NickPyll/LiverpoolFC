remaining.opp.form.by.week <-
  plot_ly(rofbw.data, type = "box") |>
  add_boxplot(
    y = ~Arsenal, name = "Arsenal",
  ...
  add_boxplot(
    y = ~AstonVilla, name = "Aston Villa",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(149,191,229)",
  ...
  add_boxplot(
    y = ~Bournemouth, name = "Bournemouth",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(181, 14, 18)",
  ...
  add_boxplot(
    y = ~CrystalPalace, name = "Crystal Palace",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(27, 69, 143)",
  ...
  add_boxplot(
    y = ~Leicester, name = "Leicester City",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(0, 83, 160)",
  ...
  add_boxplot(
    y = ~ManCity, name = "Manchester City",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(108, 171, 221)",
  ...
  add_boxplot(
    y = ~ManUnited, name = "Manchester United",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(218, 41, 28)",
  ...
  add_boxplot(
    y = ~NottmForest, name = "Nottingham Forest",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(229, 50, 51)",
  ...
  add_boxplot(
    y = ~Southampton, name = "Southampton",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(215, 25, 32)",
  ...
  add_boxplot(
    y = ~WestHam, name = "West Ham United",
    boxpoints = "suspectedoutliers",
    marker = list(
      color = "rgb(122, 38, 58)",
  ...
  layout(
    title = paste("Remaining Opponent Form <br>", max(rby.data$year), "-", max(rby.data$year) + 1),
