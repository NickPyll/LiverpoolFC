...
predicted.points.by.week <-
  ...
  add_trace(
    y = ~Burnley, name = "Burnley", type = "scatter", mode = "lines",
  ...
  add_trace(
    y = ~Luton, name = "Luton Town", type = "scatter", mode = "lines",
  ...
  add_trace(
    y = ~SheffieldUnited, name = "Sheffield United", type = "scatter", mode = "lines",
  ...
  layout(
    ...
    shapes = list(
      ...
      list(
        type = "rect", fillcolor = "rgba(220, 220, 220, .2)", line = list(color = "rgba(220, 220, 220, .2)"),
        x0 = 0, x1 = 38, xref = "x",
        y0 = 34, y1 = 42, yref = "y"
      ),
      list(
      ...
      list(
        type = "line", line = list(color = "black", dash = "dot"),
