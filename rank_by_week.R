...
rank.by.week <- 
  ...
  #           line = list(color = 'rgb(14, 99, 173)', width = 1)) %>%
  add_trace(y = ~Leicester, name = 'Leicester City', type = 'scatter', mode = 'lines', 
            line = list(color = 'rgb(0, 83, 160)', width = 1)) %>%
