...
x.premier.league.clubs <-
  tribble(
    ...
    'Brentford', 'Brentford', rgb(227, 6, 19, maxColorValue = 255),
    ...
    'Fulham', 'Fulham', rgb(0, 0, 0, maxColorValue = 255),
    ...
    'Nottm Forest', 'Nottingham Forest', rgb(229, 50, 51, maxColorValue = 255),
    ...
    # 'West Brom', 'West Bromwich Albion', rgb(18, 47, 103, maxColorValue = 255),
